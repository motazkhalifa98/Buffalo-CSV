...
object Main {
  ...
  def main(args: Array[String]): Unit = {
    ...
    for (entry <- loadEntries(filename, numLines)) {
     /* println("-----------")
      print("INSERTING: ")
      println(entry.infoMap.getOrElse("ADDRESS", ""))
    */  taxEntryStore.insert(entry)
    /*  println(taxEntryStore)
      print("Size of Array: ")
      println(taxEntryStore.size)
      print("Size of numStored: ")
      println(taxEntryStore.length)
   */ }
    ...
    println("-----")
/*
    println("REGROOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOUP")
    println("")
    println("")
    println("")
    println("")
...
*/
  ...
  /*  var iter = taxEntryStore.iterator("Elmwood Bidwell")
    while (iter.hasNext){
      println(iter.next().infoMap.getOrElse("ADDRESS", ""))
    }
*/
